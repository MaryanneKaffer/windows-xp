export const Appearance = [
    ...
    },
    {
        ...
        inactiveWindow: "bg-lollypopInactive",
        inactiveBorder: "border-[#E2ACE7]",
        border: "border-[rgb(243_114_255)]",
        startmenu: 'bg-lollypopStartmenu',
        sample: '/appearances/lollypop.png',
    ...
    },
    {
        ...
        inactiveWindow: "bg-oliveInactive",
        inactiveBorder: "border-[#D3E7B4]",
        border: "border-[rgb(180_202_148)]",
        startmenu: 'bg-oliveStartmenu',
        sample: '/appearances/oliveGreen.png',
    ...
    },
    {
        ...
        inactiveWindow: "bg-silverInactive",
        inactiveBorder: "border-[#E6E7F1]",
        border: "border-[rgb(148_150_175)]",
        startmenu: 'bg-silverStartmenu',
        sample: '/appearances/silver.png',
    ...
    },
    {
        ...
        inactiveWindow: "bg-zuneInactive",
        inactiveBorder: "border-[#797979]",
        border: "border-black",
        startmenu: 'bg-zuneStartmenu',
        sample: '/appearances/zune.png',
