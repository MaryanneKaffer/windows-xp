...
import InternetComponent from "./windowComponents/internetComponent";
...
export default function FloatingWindow({ name, icon, type, onClose, fixedSize, isProperties, width, height, mobileHeight, mobileWidth, activeWindow, setActiveWindow, isHidden, setIsHidden }: FloatingWindowProps) {
        ...
        <div >
            ...
            >
                ...
                <div className="h-[100%] bg-white overflow-hidden">
                    ...
                    {type === "Internet" && <InternetComponent icon={icon} />}
                </div>
            </div>
        </div >
    );
