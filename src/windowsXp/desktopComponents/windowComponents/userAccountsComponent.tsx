    ...
    return (
        <section className="w-full h-full">
            ...
            <div className="flex w-full h-full">
                ...
                <div className="md:w-full w-[58%] lg:p-10 px-4 py-2">
                    ...
                    <div className="overflow-y-auto h-[36.5%] w-full lg:border-3 border-2 mt-5 flex flex-wrap lg:gap-[7px] lg:p-2 p-1">
