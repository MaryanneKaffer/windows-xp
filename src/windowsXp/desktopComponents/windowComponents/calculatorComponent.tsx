            ...
            <div className="flex flex-col w-full h-full px-2 gap-2">
                ...
                <span className="flex flex-col gap-2 px-1 h-full mt-2">
                    <span className="justify-between flex w-full h-fit items-center">
                        <span className="md:size-11 size-8 flex md:mr-2.5 md:ml-1.5 mr-4 ml-0.5"><div className="md:size-9 size-8 my-auto border-t-[3px] border-l-[3px] border-b-[2px] border-r-[2px] border-b-white border-r-white border-gray-500" /></span>
                        {topInputs.map((input) => (
                            <button key={input.output} className={`${currentAppearance.border} group font-bold cursor-default border-[2px] rounded-md bg-white text-red-900 text-xl md:w-[26%] w-[26%] mdh-11 flex items-center justify-center`}
                    ...
                    <span className="justify-between flex flex-wrap w-full items-center md:mt-2 mt-1">
                        ...
                        w-[14%] md:h-11 flex items-center justify-center ${input.space && "mr-2"} mb-2`}
                                onClick={() => {
