    ...
    return (
        <div className="w-full lg:h-[85%] h-[305px]  border-gray-400 border-[2px] rounded-md rounded-t-none text-black px-4 relative">
            ...
            <div className="flex gap-2">
                <div className="border-2 border-gray-400 lg:h-[125px] w-[75%] h-[75px] flex flex-col px-1 overflow-y-scroll">
                    {Wallpapers.map((wallpaper, index) => (
                        <div key={index} className="h-5 ">
                            <Image src={selectedWallpaper ? selectedWallpaper : currentWallpaper} alt={wallpaper.name} width={162} height={120} draggable={false} className="lg:w-[162px] lg:h-[120px] w-[123px] h-[88px] object-cover absolute lg:top-7 top-[21px] right-[90px] lg:left-[156px]" />
                    ...
                    <button className="cursor-default w-auto h-[28px] border-gray-500 border-2 rounded-md my-2 leading-none active:border-winXpBlue px-4 lg:hidden absolute bottom-[6px] left-8">Customize Desktop...</button>
                </div>
