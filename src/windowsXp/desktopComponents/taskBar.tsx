        ...
        <section className="w-full h-screen flex">
            <div className="w-full h-[48px] bg-taskBar self-end flex">
                <Popover onOpenChange={setIsOpen}>
                    ...
                    <PopoverContent
                        className="bg-window border-[2px] border-[#245DDA] rounded-t-xl fixed !transition-none !duration-0 p-0 
                ...
                <div className="bg-systemTray lg:w-[225px] w-[100px] flex place-items-center relative ml-auto relative">
