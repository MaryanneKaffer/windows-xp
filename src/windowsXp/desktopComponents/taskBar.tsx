    ...
    return (
        <section className={`w-full h-[48px] ${currentAppearance.taskbar} absolute bottom-0 left-0 flex`}>
            <div className="w-full h-[48px] relative">
                ...
                {isOpen && (
                    <div ref={ref} className={`${currentAppearance.startmenu} border-[2px] ${currentAppearance.border} rounded-b-none rounded-t-xl absolute p-0 lg:w-[550px] lg:h-[700px] lg:bottom-[48px] lg:left-0 w-screen h-[650px] bottom-[48px] left-0`}>
